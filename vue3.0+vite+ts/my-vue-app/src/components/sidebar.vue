<template>
  <div class="Sidebar">
    ...
    <el-menu :default-active="activeMenu " class="el-menu-vertical-demo" background-color="#2D3E51" text-color="#fff"
      :unique-opened="false" @open="handleOpen" @close="handleClose">
